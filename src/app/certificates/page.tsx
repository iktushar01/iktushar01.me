...
import { fetchCertificates } from "@/lib/api/portfolio";

export const metadata: Metadata = {
  title: "Certificates — Tushar's Portfolio",
  description:
    "Professional certifications and credentials earned by Tushar — full-stack developer.",
};
